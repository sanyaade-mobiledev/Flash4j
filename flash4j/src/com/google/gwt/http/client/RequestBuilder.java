/************************************************************************
  RequestBuilder.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
import com.emitrom.air4j.core.client.AIR;
        ...
        xmlHttpRequest.setOnReadyStateChange(new ReadyStateChangeHandler() {
            public void onReadyStateChange(XMLHttpRequest xhr) {
                if (xhr.getReadyState() == XMLHttpRequest.DONE) {
                    ...
                    /**
                     * Avoid new Function security error in Adobe AIR
                     */
                    if (!AIR.isCurrentRuntime()) {
