...
public class Spas {
     ...
     * method on
     * 
     * @param handler,the passed handler, the handler to call after the spas
     ...
     * @param handler, the handler to be called once the SwfWidgetLoader
     *            framework was successfully loaded
     ...
     */
    public static SpasApplication getRootPanel() {
        return SpasApplication.get();
    }
