...
class SpasApplication extends Application {
    ...
    public static final SpasApplication INSTANCE = new SpasApplication();

    private SpasApplication() {
        jsObj = Bridge.get().getRoot();
    }

    SpasApplication(JavaScriptObject obj) {
        jsObj = obj;
    }

    public static SpasApplication get() {
        return INSTANCE;
    }
