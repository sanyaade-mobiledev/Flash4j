/************************************************************************
 * StarlingLoaderGeckoImpl.java is part of Flash4j 3.0.0 Copyright 2012 Emitrom
 * LLC
 * 
...
public class StarlingLoaderGeckoImpl implements StarlingLoader {

    @Override
    public Widget load(int width, int height, StartHandler handler) {
        final SWFABridgeGeckoWidget swfWidget = new SWFABridgeGeckoWidget(StarlingLoader.PATH, width, height);
        swfWidget.addAttribute("bridgeName", Core.BRIDGE_NAME);
        swfWidget.addAttribute("name", "swfID_0");
        swfWidget.addAttribute("wmode", "direct");
        ...
        swfWidget.addParam("wmode", "direct");
