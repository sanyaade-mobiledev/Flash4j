/************************************************************************
  StarlingLoaderDefaultImpl.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class StarlingLoaderDefaultImpl implements StarlingLoader {

    @Override
    public Widget load(int width, int height, final StartHandler handler) {
        SWFParams params = new SWFParams(StarlingLoader.PATH, width, height);
