/************************************************************************
 * ResizablePanel.java is part of Flash4j 3.0.0 Copyright 2012 Emitrom LLC
 * 
...
/**
 * The Class ResizablePanel.
 */
public class ResizablePanel extends Panel {

    /**
     * Instantiates a new resizable panel.
     */
    protected ResizablePanel(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * New instance.
     * 
     * @return the resizable panel
     */
    public ResizablePanel() {
        jsObj = Bridge.createObject("flex.utils.ui.resize.ResizablePanel");
    }
     ...
     * @return the resizable panel
     */
    public ResizablePanel(String title) {
        this();
        setTitle(title);
    }
