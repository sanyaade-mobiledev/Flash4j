/************************************************************************
  FlipAway3D.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class FlipAway3D extends Away3DEffect {
    ...
    /**
     * Instantiates a new flip away3 d.
     */
    protected FlipAway3D(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * New instance.
     * 
     * @return the flip away3 d
     */
    public FlipAway3D() {
        jsObj = Bridge.createObject("org.efflex.mx.viewStackEffects.FlipAway3D");
    }
     ...
     * @return the flip away3 d
     */
    public FlipAway3D(UIComponent target) {
        this();
        setTarget(target);
    }
