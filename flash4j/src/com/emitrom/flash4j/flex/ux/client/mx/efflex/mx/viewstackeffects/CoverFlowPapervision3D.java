/************************************************************************
  CoverFlowPapervision3D.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class CoverFlowPapervision3D.
 */
public class CoverFlowPapervision3D extends PaperVision3DEffect {
    ...
    /**
     * Instantiates a new cover flow papervision3 d.
     */
    protected CoverFlowPapervision3D(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * New instance.
     * 
     * @return the cover flow papervision3 d
     */
    public CoverFlowPapervision3D() {
        jsObj = Bridge.createObject("org.efflex.mx.viewStackEffects.CoverFlowPapervision3D");
    }
     ...
     * @return the cover flow papervision3 d
     */
    public CoverFlowPapervision3D(UIComponent target) {
        this();
        setTarget(target);
    }
