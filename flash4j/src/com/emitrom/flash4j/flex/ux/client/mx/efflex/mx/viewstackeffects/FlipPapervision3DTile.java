/************************************************************************
 * FlipPapervision3DTile.java is part of Flash4j 3.0.0 Copyright 2012 Emitrom
 * LLC
 * 
...
/**
 * The Class FlipPapervision3DTile.
 */
public class FlipPapervision3DTile extends Papervision3DTileEffect {
    ...
    /**
     * Instantiates a new flip papervision3 d tile.
     */
    protected FlipPapervision3DTile(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * New instance.
     * 
     * @return the flip papervision3 d tile
     */
    public FlipPapervision3DTile() {
        jsObj = Bridge.createObject("org.efflex.mx.viewStackEffects.FlipPapervision3DTile");
    }
     ...
     * @return the flip papervision3 d tile
     */
    public FlipPapervision3DTile(UIComponent target) {
        this();
        setTarget(target);
    }
