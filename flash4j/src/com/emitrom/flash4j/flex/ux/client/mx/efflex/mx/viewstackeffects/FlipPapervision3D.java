/************************************************************************
  FlipPapervision3D.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class FlipPapervision3D extends PaperVision3DEffect {
    ...
    /**
     * Instantiates a new flip papervision3 d.
     */
    protected FlipPapervision3D(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * New instance.
     * 
     * @return the flip papervision3 d
     */
    public FlipPapervision3D() {
        jsObj = Bridge.createObject("org.efflex.mx.viewStackEffects.FlipPapervision3D");
    }
     ...
     * @return the flip papervision3 d
     */
    public FlipPapervision3D(UIComponent target) {
        this();
        setTarget(target);
    }
