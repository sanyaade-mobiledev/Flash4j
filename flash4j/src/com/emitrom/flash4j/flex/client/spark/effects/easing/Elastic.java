/************************************************************************
  Elastic.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
 ...
 * The Class Elastic.
 */
public class Elastic extends ProxyObject implements IEaser {

    /**
     * Instantiates a new elastic.
     */
    protected Elastic(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public Elastic() {
        jsObj = Bridge.createObject("spark.effects.easing.Elastic");
    }

    public Elastic(EasingFraction fraction) {
        this();
        ease(fraction);
    }
