/************************************************************************
  Scale.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class Scale extends AnimateTransform {
     ...
     */
    protected Scale(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public Scale() {
        jsObj = Bridge.createObject("spark.effects.Scale");
    }
     ...
     * @return the scale
     */
    public Scale(ProxyObject target) {
        super(target);
    }
