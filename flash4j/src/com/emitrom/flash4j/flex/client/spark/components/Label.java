...
import com.emitrom.flash4j.flex.client.spark.components.supportClasses.TextBase;
...
public class Label extends TextBase {
     ...
     */
    public Label() {
        jsObj = Bridge.createObject("spark.components.Label");
    }
