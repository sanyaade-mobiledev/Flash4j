/************************************************************************
  LineChart.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class LineChart extends CartesianChart {
     ...
     */
    protected LineChart(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public LineChart() {
        jsObj = Bridge.createObject("mx.charts.LineChart");
    }
}
