...
public enum ProgressBarLabelPlacement {
    ...
    public static native ProgressBarLabelPlacement fromValue(String value) /*-{
		switch (value) {
		case 'bottom':
			return @com.emitrom.flash4j.flex.client.ui.mx.ProgressBarLabelPlacement::BOTTOM;
		case 'left':
			return @com.emitrom.flash4j.flex.client.ui.mx.ProgressBarLabelPlacement::LEFT;
		case 'right':
			return @com.emitrom.flash4j.flex.client.ui.mx.ProgressBarLabelPlacement::RIGHT;
		case 'top':
			return @com.emitrom.flash4j.flex.client.ui.mx.ProgressBarLabelPlacement::TOP;
		case 'center':
			return @com.emitrom.flash4j.flex.client.ui.mx.ProgressBarLabelPlacement::CENTER
		}
    }-*/;
}
