...
public class Slider extends UIComponent {
    ...
    public native SliderThumb getThumbAt(int index)/*-{
		...
		return @com.emitrom.flash4j.flex.client.ui.mx.SliderThumb::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
