/************************************************************************
 * ViewStack.java is part of Flash4j 3.0.0 Copyright 2012 Emitrom LLC
 * 
...
public class ViewStack extends Container {
    ...
    /**
     * Instantiates a new view stack.
     */
    protected ViewStack(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public ViewStack() {
        jsObj = Bridge.createObject("mx.containers.ViewStack");
    }
