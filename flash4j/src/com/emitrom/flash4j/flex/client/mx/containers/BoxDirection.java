...
public enum BoxDirection {
    ...
    public static native BoxDirection fromValue(String value) /*-{
		switch (value) {
		case 'horizontal':
			return @com.emitrom.flash4j.flex.client.mx.containers.BoxDirection::HORIZONTAL;
		case 'vertical':
			return @com.emitrom.flash4j.flex.client.mx.containers.BoxDirection::VERTICAL
		}
    }-*/;
}
