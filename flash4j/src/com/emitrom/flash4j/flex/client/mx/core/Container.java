 ...
 */
public class Container extends UIComponent implements INavigatorContent {
    ...
    public native ScrollBar getHorizontalScrollBar()/*-{
		...
		return @com.emitrom.flash4j.flex.client.mx.controls.scrollClasses.ScrollBar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
