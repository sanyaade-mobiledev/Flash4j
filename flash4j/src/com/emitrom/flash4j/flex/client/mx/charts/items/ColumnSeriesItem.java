/************************************************************************
  ColumnSeriesItem.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class ColumnSeriesItem.
 */
public class ColumnSeriesItem extends ChartItem {

    /**
     * Instantiates a new column series item.
     */
    protected ColumnSeriesItem(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * Creates the.
     * 
     * @return the column series item
     */
    public ColumnSeriesItem() {
        jsObj = Bridge.createObject("mx.charts.items.ColumnSeriesItem");
        setElement(null);
        setItem(null);
        setIndex(0);
    }
