 ...
 */
public class PNGEncoder extends ProxyObject implements IImageEncoder {

    /**
     * Instantiates a new pNG encoder.
     */
    protected PNGEncoder(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public PNGEncoder() {
        jsObj = Bridge.createObject("mx.graphics.codec.PNGEncoder");
    }
