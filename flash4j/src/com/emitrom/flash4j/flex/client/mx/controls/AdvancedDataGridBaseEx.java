/************************************************************************
  AdvancedDataGridBaseEx.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
import com.emitrom.flash4j.flex.client.mx.controls.advancedDataGridClasses.AdvancedDataGridBase;
import com.emitrom.flash4j.flex.client.mx.controls.advancedDataGridClasses.AdvancedDataGridColumn;
import com.emitrom.flash4j.flex.client.mx.controls.advancedDataGridClasses.SortInfo;
...
public class AdvancedDataGridBaseEx extends AdvancedDataGridBase {
     ...
     * 
     * @param value the new draggable columns
     */
     ...
     * 
     * @param value the new edited item position
     */
     ...
     * 
     * @param value the new look ahead duration
     */
     ...
     * 
     * @param value the new min column width
     */
     ...
     * 
     * @param value the new resizable columns
     */
     ...
     * 
     * @param value the new sortable columns
     */
     ...
     * 
     * @param value the new sort expert mode
     */
    ...
    public native SortInfo getFieldSortInfo(AdvancedDataGridColumn column)/*-{
		...
		return @com.emitrom.flash4j.flex.client.mx.controls.advancedDataGridClasses.SortInfo::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
