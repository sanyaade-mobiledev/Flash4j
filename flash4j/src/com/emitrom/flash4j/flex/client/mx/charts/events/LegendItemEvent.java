...
import com.emitrom.flash4j.flex.client.mx.charts.LegendItem;
...
public class LegendItemEvent extends MouseEvent {
    ...
    public final native LegendItem getItem()/*-{
		...
		return @com.emitrom.flash4j.flex.client.mx.charts.LegendItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
