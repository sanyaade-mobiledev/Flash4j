/************************************************************************
  SetProperty.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class SetProperty.
 */
public class SetProperty extends OverrideBase {

    /**
     * Instantiates a new sets the property.
     */
    protected SetProperty(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public SetProperty() {
        jsObj = Bridge.createObject("mx.states.SetProperty");
    }
