/************************************************************************
  AdvancedDataGridColumn.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
import com.emitrom.flash4j.flex.client.mx.formatters.Formatter;
import com.emitrom.flash4j.flex.client.mx.styles.CSSStyleDeclaration;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * The Class AdvancedDataGridColumn.
 */
public class AdvancedDataGridColumn extends CSSStyleDeclaration {

    /**
     * Instantiates a new advanced data grid column.
     */
    public AdvancedDataGridColumn(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * Sets the data field.
     * 
     * @param value the new data field
     */
     ...
     * 
     * @param value the new data tip field
     */
     ...
     * 
     * @param value the new editor data field
     */
     ...
     * 
     * @param value the new editor height offset
     */
     ...
     * 
     * @param value the new editor uses enter key
     */
     ...
     * 
     * @param value the new editor width offset
     */
     ...
     * 
     * @param value the new editor x offset
     */
     ...
     * 
     * @param value the new editor y offset
     */
    ...
    public native Formatter getFormatter()/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer.getformatter();
		return @com.emitrom.flash4j.flex.client.mx.formatters.Formatter::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;

    /**
     * Sets the formatter.
     * 
     * @param value the new formatter
     */
    public native void setFormatter(Formatter value)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setformatter(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
     ...
     * 
     * @param value the new header text
     */
     ...
     * 
     * @param value the new renderer is editor
     */
     ...
     * 
     * @param value the new sort descending
     */
    ...
    public native AdvancedDataGridColumn cloneObject()/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer.clone();
     ...
     * 
     * @param value the value
     * @param withFormatting the with formatting
     * @return the string
     */
