/************************************************************************
  BubbleSeriesItem.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class BubbleSeriesItem.
 */
public class BubbleSeriesItem extends ChartItem {

    /**
     * Instantiates a new bubble series item.
     */
    protected BubbleSeriesItem(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * New instance.
     * 
     * @return the bubble series item
     */
    public BubbleSeriesItem() {
        jsObj = Bridge.createObject("mx.charts.items.BubbleSeriesItem");
        setElement(null);
        setItem(null);
        setIndex(0);
    }
