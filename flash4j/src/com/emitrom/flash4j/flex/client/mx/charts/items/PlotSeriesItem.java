/************************************************************************
  PlotSeriesItem.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class PlotSeriesItem.
 */
public class PlotSeriesItem extends ChartItem {

    /**
     * Instantiates a new plot series item.
     */
    protected PlotSeriesItem(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * Creates the.
     * 
     * @return the plot series item
     */
    public PlotSeriesItem() {
        jsObj = Bridge.createObject("mx.charts.items.PlotSeriesItem");
        setElement(null);
        setItem(null);
        setIndex(0);
    }
