...
public class AdvancedListBase extends ScrollControlBase {
     ...
     * 
     * @param value the new allow drag selection
     */
     ...
     * 
     * @param value the new allow multiple selection
     */
     ...
     * 
     * @param col the new data provider
     */
     ...
     * 
     * @param value the new locked column count
     */
     ...
     * 
     * @param value the new locked row count
     */
     ...
     * 
     * @param value the new menu selection mode
     */
     ...
     * 
     * @param value the new offsreen extra column
     */
     ...
     * 
     * @param value the new offsreen extra row
     */
     ...
     * 
     * @param values the new selected items
     */
     ...
     * Sets the selected items.
     * 
     * @param collection the new selected items
     */
     ...
     * Sets the selected items.
     * 
     * @param value the new selected items
     */
