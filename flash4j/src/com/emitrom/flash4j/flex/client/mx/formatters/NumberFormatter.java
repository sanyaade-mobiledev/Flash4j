/************************************************************************
  NumberFormatter.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class NumberFormatter extends Formatter {
     ...
     */
    protected NumberFormatter(JavaScriptObject obj) {
        jsObj = obj;
    }
    ...
    public NumberFormatter() {
        jsObj = Bridge.createObject("mx.formatters.NumberFormatter");
    }
