/************************************************************************
  ComboBox.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class ComboBox extends ComboBase {
     ...
     */
    protected ComboBox(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public ComboBox() {
        jsObj = Bridge.createObject("mx.controls.ComboBox");
    }

    public ComboBox(ArrayCollection dataProvider) {
        this();
     ...
     * @return the dropdown
     */
    public native ListBase getDropdown()/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer.getdropdown();
		return @com.emitrom.flash4j.flex.client.mx.controls.listClasses.ListBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;

    /**
     * Gets the dropdown width.
     * 
     * @return the dropdown width
     */
    public native double getDropdownWidth()/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     * 
     * @param value the new drop down width
     */
    public native void setDropDownWidth(double value)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer.setdropDownWidth(value);
    }-*/;
    ...
    /**
     * Sets the base list data.
     * 
     * @param value the new base list data
     */
    public native void setBaseListData(BaseListData value)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer.setbaseListData(value);
    }-*/;
     ...
     * @return the string
     */
    public native String itemToLabel(Object item, Object... rest)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer.itemToLabel.apply(item, rest);
    }-*/;
