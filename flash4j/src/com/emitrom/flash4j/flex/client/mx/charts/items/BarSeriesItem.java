/************************************************************************
  BarSeriesItem.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class BarSeriesItem.
 */
public class BarSeriesItem extends ChartItem {

    /**
     * Instantiates a new bar series item.
     */
    protected BarSeriesItem(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * New instance.
     * 
     * @return the bar series item
     */
    public BarSeriesItem() {
        jsObj = Bridge.createObject("mx.charts.items.BarSeriesItem");
        setElement(null);
        setItem(null);
        setIndex(0);
    }
