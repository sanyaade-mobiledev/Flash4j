/************************************************************************
  AreaSeriesItem.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class AreaSeriesItem.
 */
public class AreaSeriesItem extends ChartItem {

    /**
     * Instantiates a new area series item.
     */
    protected AreaSeriesItem(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * New instance.
     * 
     * @return the area series item
     */
    public AreaSeriesItem() {
        jsObj = Bridge.createObject("mx.charts.items.AreaSeriesItem");
        setElement(null);
        setItem(null);
        setIndex(0);
