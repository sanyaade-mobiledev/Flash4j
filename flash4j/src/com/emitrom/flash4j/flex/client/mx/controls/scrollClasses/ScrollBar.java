...
public class ScrollBar extends UIComponent {
     ...
     * 
     * @param value the new line scroll size
     */
     ...
     * 
     * @param value the new max scroll position
     */
     ...
     * 
     * @param value the new min scroll position
     */
     ...
     * 
     * @param value the new page scroll size
     */
     ...
     * @param minScrollPosition the min scroll position
     * @param maxScrollPosition the max scroll position
     */
     ...
     * @param minScrollPosition the min scroll position
     * @param maxScrollPosition the max scroll position
     * @param pageScrollSize the page scroll size
     */
    public native void setScrollProperties(double pageSize, double minScrollPosition, double maxScrollPosition,
