/************************************************************************
  PlotChart.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class PlotChart extends CartesianChart {
    ...
    /**
     * Instantiates a new plot chart.
     */
    protected PlotChart(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public PlotChart() {
        jsObj = Bridge.createObject("mx.charts.PlotChart");
    }
}
