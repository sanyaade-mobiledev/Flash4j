/************************************************************************
  ColumnSeries.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class ColumnSeries.
 */
public class ColumnSeries extends Series {

    /**
     * Instantiates a new column series.
     */
    protected ColumnSeries(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public ColumnSeries() {
        jsObj = Bridge.createObject("mx.charts.series.ColumnSeries");
    }
