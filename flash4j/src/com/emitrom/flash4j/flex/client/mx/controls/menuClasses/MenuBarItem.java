...
**************************************************************************/
package com.emitrom.flash4j.flex.client.mx.controls.menuClasses;
...
public class MenuBarItem extends UIComponent {
     ...
     * 
     * @param value the new menu bar item index
     */
     ...
     * 
     * @param value the new menu bar item state
     */
