/************************************************************************
  ControlBar.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class ControlBar extends Box {
     ...
     */
    protected ControlBar(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public ControlBar() {
        jsObj = Bridge.createObject("mx.containers.ControlBar");
    }
}
