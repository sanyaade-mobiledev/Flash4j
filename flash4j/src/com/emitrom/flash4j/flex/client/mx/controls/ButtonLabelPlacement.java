...
public enum ButtonLabelPlacement {
    ...
    public static native ButtonLabelPlacement fromValue(String value) /*-{
		switch (value) {
		case 'bottom':
			return @com.emitrom.flash4j.flex.client.mx.controls.ButtonLabelPlacement::BOTTOM;
		case 'left':
			return @com.emitrom.flash4j.flex.client.mx.controls.ButtonLabelPlacement::LEFT;
		case 'right':
			return @com.emitrom.flash4j.flex.client.mx.controls.ButtonLabelPlacement::RIGHT;
		case 'top':
			return @com.emitrom.flash4j.flex.client.mx.controls.ButtonLabelPlacement::TOP;
		}
    }-*/;
}
