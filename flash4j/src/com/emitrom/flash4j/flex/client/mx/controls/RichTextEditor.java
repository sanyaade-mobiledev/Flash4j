...
import com.emitrom.flash4j.flex.client.mx.controls.textClasses.TextRange;
...
public class RichTextEditor extends Panel {
     ...
     * 
     * @param value the new align tool tip
     */
     ...
     * 
     * @param value the new bold tool tip
     */
     ...
     * 
     * @param value the new bullet tool tip
     */
     ...
     * 
     * @param value the new color tool tip
     */
     ...
     * 
     * @param value the new default link protocol
     */
     ...
     * 
     * @param value the new font family tool tip
     */
     ...
     * 
     * @param value the new font size tool tip
     */
     ...
     * 
     * @param value the new italic tool tip
     */
     ...
     * 
     * @param value the new link tool tip
     */
    ...
    public native TextRange getSelection()/*-{
		...
		return @com.emitrom.flash4j.flex.client.mx.controls.textClasses.TextRange::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
     ...
     * 
     * @param value the new show control bar
     */
     ...
     * 
     * @param value the new show tool tips
     */
     ...
     * 
     * @param value the new under line tool tip
     */
