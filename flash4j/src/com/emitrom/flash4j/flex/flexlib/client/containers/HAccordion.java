/************************************************************************
  HAccordion.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class HAccordion.
 */
public class HAccordion extends AccordionBase {

    /**
     * Instantiates a new h accordion.
     */
    protected HAccordion(JavaScriptObject obj) {
        super(obj);
    }
     ...
     * New instance.
     * 
     * @return the h accordion
     */
    public HAccordion() {
        jsObj = Bridge.createObject("flexlib.containers.HAccordion");
    }
