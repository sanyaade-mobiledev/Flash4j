/************************************************************************
  PromptingTextInput.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
/**
 * The Class PromptingTextInput.
 */
public class PromptingTextInput extends TextInput {

    /**
     * Instantiates a new prompting text input.
     */
    protected PromptingTextInput(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * @param prompt
     *            the prompt
     * @return the prompting text input
     */
    public PromptingTextInput(String prompt) {
        this();
        setPrompt(prompt);
    }
     ...
     * @return the prompting text input
     */
    public PromptingTextInput() {
        jsObj = Bridge.createObject("flexlib.controls.PromptingTextInput");
    }
