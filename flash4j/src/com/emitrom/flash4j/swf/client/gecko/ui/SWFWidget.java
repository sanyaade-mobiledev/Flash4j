...
import com.emitrom.flash4j.swf.client.gecko.utils.PlayerVersion;
import com.emitrom.flash4j.swf.client.gecko.utils.SWFObjectUtil;
...
public class SWFWidget extends Widget {
    ...
    @SuppressWarnings("rawtypes")
    protected native void injectSWF(String swf, String id, String w, String h, String ver, Map/*
                                                                                               * <
                                                                                               * String
                                                                                               * ,
                                                                                               * String
		...
		var _vars = @com.emitrom.flash4j.swf.client.gecko.utils.SWFObjectUtil::convertHashMapToJSArray(Ljava/util/Map;)(flashvars);
		var _params = @com.emitrom.flash4j.swf.client.gecko.utils.SWFObjectUtil::convertHashMapToJSArray(Ljava/util/Map;)(params);
		var _attributes = @com.emitrom.flash4j.swf.client.gecko.utils.SWFObjectUtil::convertHashMapToJSArray(Ljava/util/Map;)(attributes);
    ...
    private void initEmptyInnerDiv() {
        String notifyText = swfSettings.getInnerDivTextForFlashPlayerNotFound().replaceAll(
                        "\\$\\{flashPlayer.version\\}", getSwfSettings().getMinPlayerVersion().toString());
        getElement().setInnerHTML("<div id='" + swfId + "' style='width:100%;height:100%;'>" + notifyText + "</div>");
    }
    ...
    protected void onLoad() {
        if (!isSWFInjected) {
            ...
            injectSWF(getSrc(), getSwfId(), getWidth(), getHeight(), swfSettings.getMinPlayerVersion().toString(),
    ...
    public PlayerVersion getMinPlayerVersion() {
        return minPlayerVersion == null ? getSwfSettings().getMinPlayerVersion() : minPlayerVersion;
    }

    /**
     * Sets the min player version.
     * 
     * @param playerVersion the new min player version
     */
