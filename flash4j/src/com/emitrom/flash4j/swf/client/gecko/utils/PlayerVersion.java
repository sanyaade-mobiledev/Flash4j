/************************************************************************
  PlayerVersion.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
package com.emitrom.flash4j.swf.client.gecko.utils;
...
public class PlayerVersion {
    ...
    public native void deserialize(JavaScriptObject o) /*-{
		...
		this.@com.emitrom.flash4j.swf.client.gecko.utils.PlayerVersion::setMajor(I)(o.major);
		this.@com.emitrom.flash4j.swf.client.gecko.utils.PlayerVersion::setMinor(I)(o.minor);
		this.@com.emitrom.flash4j.swf.client.gecko.utils.PlayerVersion::setRev(I)(o.release);
    ...
    public native void _deserialize(JavaScriptObject o) /*-{
		...
		this.@com.emitrom.flash4j.swf.client.gecko.utils.PlayerVersion::setMajor(I)(o.major);
		this.@com.emitrom.flash4j.swf.client.gecko.utils.PlayerVersion::setMinor(I)(o.minor);
		this.@com.emitrom.flash4j.swf.client.gecko.utils.PlayerVersion::setRev(I)(o.rev);
