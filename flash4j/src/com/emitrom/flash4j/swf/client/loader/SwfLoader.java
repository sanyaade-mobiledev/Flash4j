...
public interface SwfLoader {
     ...
     * 
     * @param width, the width of the returned widget
     * @param height, the handler of the returned widget
     * @param handler, the handler to call one the swf is successfully loaded
     * @return
     */
