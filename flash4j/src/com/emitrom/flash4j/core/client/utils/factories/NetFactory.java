/************************************************************************
  NetFactory.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
import com.emitrom.flash4j.core.client.net.NetConnection;
 ...
 */
public class NetFactory extends ProxyObject {
    ...
    public final native JavaScriptObject createNetGroup(NetConnection connection, String groupSpec)/*-{
		...
		return peer
				.createNetGroup(
						connection.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						groupSpec);
    }-*/;
    ...
    public final native JavaScriptObject createNetStream(NetConnection connection)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.createNetStream(connection.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public final native JavaScriptObject createURLLoader(URLRequest urlRequest)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.createURLLoader(urlRequest.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public final native JavaScriptObject createDRMContentData(ByteArray rawData)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.createDRMContentData(rawData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
