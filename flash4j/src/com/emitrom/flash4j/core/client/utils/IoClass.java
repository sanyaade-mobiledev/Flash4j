...
import com.emitrom.flash4j.core.client.net.ObjectEncoding;
...
public class IoClass extends EventDispatcher implements IDataInput, IDataOutput {
    ...
    public native void readBytes(ByteArray bytes) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.readBytes(bytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void writeBytes(ByteArray bytes) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.writeBytes(bytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
