/************************************************************************
  Flash.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
import com.emitrom.flash4j.core.detect.client.FlashDetect;

public class Flash extends ProxyObject {

    static final Flash INSTANCE = new Flash();
    public static final String FLASH_NOT_INSTALLED = "Flash seems to not be installed";
