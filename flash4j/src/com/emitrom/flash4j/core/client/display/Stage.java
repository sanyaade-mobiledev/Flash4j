...
import com.emitrom.flash4j.core.client.events.handlers.FullScreenHandler;
import com.emitrom.flash4j.core.client.events.handlers.StageVideoAvailabilityHandler;
...
public class Stage extends DisplayObjectContainer {
    ...
    public native void setFocus(InteractiveObject value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setfocus(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void setFullScreenSourceRect(Rectangle value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setfullScreenSourceRect(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addFullScreenHandler(FullScreenHandler handler)/*-{
		...
		peer
				.addEventlistener(
						@com.emitrom.flash4j.core.client.events.FullScreenEvent::FULL_SCREEN,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.FullScreenEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.flash4j.core.client.events.handlers.FullScreenHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/FullScreenEvent;)(eventObject);
						}));
    }-*/;
    ...
    public native void addStageVideoAvailabilityHandler(StageVideoAvailabilityHandler handler)/*-{
		...
		peer
				.addEventlistener(
						@com.emitrom.flash4j.core.client.events.StageVideoAvailabilityEvent::STAGE_VIDEO_AVAILABILITY,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.StageVideoAvailabilityEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.flash4j.core.client.events.handlers.StageVideoAvailabilityHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/StageVideoAvailabilityEvent;)(eventObject);
						}));
    }-*/;
