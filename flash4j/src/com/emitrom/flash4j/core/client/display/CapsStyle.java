...
public enum CapsStyle {
    ...
    public static native CapsStyle fromValue(String value) /*-{
		...
		case 'none':
			return @com.emitrom.flash4j.core.client.display.CapsStyle::NONE;

		case 'round':
			return @com.emitrom.flash4j.core.client.display.CapsStyle::ROUND;

		case 'square':
			return @com.emitrom.flash4j.core.client.display.CapsStyle::SQUARE;
