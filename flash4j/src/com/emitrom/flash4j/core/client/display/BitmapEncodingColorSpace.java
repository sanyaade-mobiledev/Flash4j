...
public enum BitmapEncodingColorSpace {
    ...
    public static native BitmapEncodingColorSpace fromValue(String value) /*-{
		switch (value) {
		case '4:2:0':
			return @com.emitrom.flash4j.core.client.display.BitmapEncodingColorSpace::COLORSPACE_4_2_0;

		case '4:2:2':
			return @com.emitrom.flash4j.core.client.display.BitmapEncodingColorSpace::COLORSPACE_4_2_2;

		case '4:4:4':
			return @com.emitrom.flash4j.core.client.display.BitmapEncodingColorSpace::COLORSPACE_4_4_4;

		case 'auto':
			return @com.emitrom.flash4j.core.client.display.BitmapEncodingColorSpace::COLORSPACE_AUTO;
		}
    }-*/;
