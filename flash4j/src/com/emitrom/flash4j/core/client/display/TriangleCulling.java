...
public enum TriangleCulling {
    ...
    public static native TriangleCulling fromValue(String value) /*-{
		...
		case 'positive':
			return @com.emitrom.flash4j.core.client.display.TriangleCulling::POSITIVE;

		case 'none':
			return @com.emitrom.flash4j.core.client.display.TriangleCulling::NONE;

		case 'negative':
			return @com.emitrom.flash4j.core.client.display.TriangleCulling::NEGATIVE;
