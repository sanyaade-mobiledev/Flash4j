...
public enum ColorCorrection {
    ...
    public static native ColorCorrection fromValue(String value) /*-{
		switch (value) {
		case 'default':
			return @com.emitrom.flash4j.core.client.display.ColorCorrection::DEFAULT;

		case 'off':
			return @com.emitrom.flash4j.core.client.display.ColorCorrection::OFF;

		case 'on':
			return @com.emitrom.flash4j.core.client.display.ColorCorrection::ON;
