...
public final class Graphics extends ProxyObject {
    ...
    public native void beginBitmapFill(BitmapData bitmap) /*-{
		...
		peer
				.beginBitmapFill(bitmap.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void beginShaderFill(Shader shader) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.beginShaderFill(shader.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void copyFrom(Graphics sourceGraphics) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.copyFrom(sourceGraphicsv.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void lineBitmapStyle(BitmapData bitmap) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.lineBitmapStyle(bitmap.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void lineShaderStyle(Shader shader) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.lineShaderStyle(shader.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void lineShaderStyle(Shader shader, Matrix matrix) /*-{
		...
		peer
				.lineShaderStyle(
						shader.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						matrix.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
