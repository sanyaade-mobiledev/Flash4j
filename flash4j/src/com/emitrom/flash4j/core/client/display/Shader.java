...
public class Shader extends ProxyObject {
    ...
    public native void setByteCode(ByteArray code) /*-{
		...
		peer
				.setbyteCode(code.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native ShaderData getData() /*-{
		...
		return @com.emitrom.flash4j.core.client.display.ShaderData::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
