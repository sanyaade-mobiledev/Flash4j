...
import com.emitrom.flash4j.core.client.geom.Transform;
...
public class DisplayObject extends EventDispatcher implements IBitmapDrawable {
    ...
    public native Shader setBlenShader(Shader value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.setblendShader(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.display.Shader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setMask(DisplayObject value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setmask(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void setScale9Grid(Rectangle value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setscale9Grid(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native Transform getTransform() /*-{
		...
		return @com.emitrom.flash4j.core.client.geom.Transform::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setTransform(Transform value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.settransform(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native Rectangle getBounds(DisplayObject targetCoordinateSpace) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.getBounds(targetCoordinateSpace.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Rectangle::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native Rectangle getRect(DisplayObject targetCoordinateSpace) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.getRect(targetCoordinateSpace.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Rectangle::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native Point globalToLocal(Point p) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.globalToLocal(p.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    ...
    public native Vector3D globalToLocal3D(Point p) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.globalToLocal3D(p.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Vector3D::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native boolean hitTestObject(DisplayObject obj) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.hitTestObject(obj.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native Point local3DToGlobal(Vector3D point3D) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.local3DToGlobal(point3D.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Point::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native Point localToGlobal(Point point) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.localToGlobal(point.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Point::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
