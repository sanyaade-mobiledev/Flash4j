...
import com.emitrom.flash4j.core.client.filters.BitmapFilter;
...
import com.emitrom.flash4j.core.client.utils.factories.BitmapDataFactory;
 ...
 */
public class BitmapData extends ProxyObject implements IBitmapDrawable {
    ...
    public native void applyFilter(BitmapData sourceBitmapData, Rectangle sourceRect, Point destPoint,
		...
		peer
				.applyFilter(
						sourceBitmapData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						sourceRect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						destPoint.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						filter.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void colorTransform(Rectangle rect, ColorTransform colorTransform) /*-{
		...
		peer
				.colorTransform(
						rect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public native <T extends JavaScriptObject> T compare(BitmapData otherBitmapData) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.compare(otherBitmapData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void copyPixels(BitmapData sourceBitmapData, Rectangle sourceRect, Point destPoint) /*-{
		...
		peer
				.copyPixels(
						sourceBitmap.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						sourceRect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						destPoint.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void copyPixels(BitmapData sourceBitmapData, Rectangle sourceRect, Point destPoint,
		...
		peer
				.copyPixels(
						...
						sourceRect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						destPoint.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						alphaBitmapData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void copyPixels(BitmapData sourceBitmapData, Rectangle sourceRect, Point destPoint,
		...
		peer
				.copyPixels(
						...
						destPoint.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						alphaBitmapData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						alphaPoint.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    private native void _draw(JavaScriptObject source) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.draw(source.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    private native void _draw(JavaScriptObject source, Matrix matrix) /*-{
		...
		peer
				.draw(
						source.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public native <T> T histogram(Rectangle hRect) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.histogram(hRect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
     ...
     */
    public native boolean hitTest(Point firstPoint, int firstAlphaThreshold, ProxyObject secondObject)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.hitTest(
						firstPoint.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						firstAlphaThreshold,
						secondObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native boolean hitTest(Point firstPoint, int firstAlphaThreshold, ProxyObject secondObject,
		...
		return peer
				.hitTest(
						...
						firstAlphaThreshold,
						secondObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						secondBitmapData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void paletteMap(BitmapData sourceBitmapData, Rectangle sourceRect, Point destPoint, int[] redArray) /*-{
		...
		peer
				.paletteMap(
						sourceBitmapData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						sourceRect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						destPoint.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()().redArray);
    }-*/;
    ...
    public native void setPixels(Rectangle rect, ByteArray inputByteArray) /*-{
		...
		peer
				.setPixels(
						rect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						inputByteArrayvar.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void unlock(Rectangle changeRect) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.unlock(changeRect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native ByteArray encode(Rectangle rect, BitmapEncoderOptions compressor)/*-{
		...
		var obj = peer
				.encode(
						rect.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						compressor.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.utils.ByteArray::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
