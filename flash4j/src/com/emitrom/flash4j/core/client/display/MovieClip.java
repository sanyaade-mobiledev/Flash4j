...
public class MovieClip extends Sprite {
    ...
    public native Scene getCurrentScene() /*-{
		...
		return @com.emitrom.flash4j.core.client.display.Scene::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void gotoAndPlay(JavaScriptObject frame, String scene) /*-{
		...
		peer
				.gotoAndPlay(
						frame,
						scene.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
