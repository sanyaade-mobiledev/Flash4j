...
public enum ColorCorrectionSupport {
    ...
    public static native ColorCorrectionSupport fromValue(String value) /*-{
		switch (value) {
		case 'defaultOff':
			return @com.emitrom.flash4j.core.client.display.ColorCorrectionSupport::DEFAULT_OFF;

		case 'defaultOn':
			return @com.emitrom.flash4j.core.client.display.ColorCorrectionSupport::DEFAULT_ON;

		case 'unsupported':
			return @com.emitrom.flash4j.core.client.display.ColorCorrectionSupport::UNSUPPORTED;
