...
import com.emitrom.flash4j.core.client.events.handlers.HttpStatusHandler;
...
import com.emitrom.flash4j.core.client.system.ApplicationDomain;
...
public class LoaderInfo extends EventDispatcher {
    ...
    public native ApplicationDomain getApplicationDomain() /*-{
		...
		return @com.emitrom.flash4j.core.client.system.ApplicationDomain::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native Loader getLoader() /*-{
		...
		return @com.emitrom.flash4j.core.client.display.Loader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void addHttpStatusHandler(HttpStatusHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.emitrom.flash4j.core.client.events.HTTPStatusEvent::HTTP_STATUS,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.HTTPStatusEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
							handler.@com.emitrom.flash4j.core.client.events.handlers.HttpStatusHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/HTTPStatusEvent;)(eventObject);
						}));
    }-*/;
    ...
    public native void addIoErrorHandler(IOErrorHandler handler)/*-{
		...
		peer
				.addEventListener(
						...
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.IOErrorEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    ...
    public native void addProgressHandler(ProgressHandler handler)/*-{
		...
		peer
				.addEventListener(
						...
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.ProgressEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
