...
public class Event extends ProxyObject {
    ...
    public ProxyObject getCurrentTarget() {
        return ProxyObject.create(_getCurrentTarget());
    }
    ...
    public ProxyObject getTarget() {
        return ProxyObject.create(_getTarget());
    }
    ...
    public native Event clone() /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer.clone();
		var toReturn = @com.emitrom.flash4j.core.client.events.Event::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
