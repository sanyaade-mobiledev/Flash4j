...
import com.emitrom.flash4j.core.client.net.drm.DRMVoucher;
...
public class DRMStatusEvent extends Event {
    ...
    public native DRMVoucher getVoucher() /*-{
		...
		return @com.emitrom.flash4j.core.client.net.drm.DRMVoucher::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
