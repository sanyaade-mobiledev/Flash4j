/************************************************************************
  EventListener.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public abstract class EventListener<T extends Event> {
    ...
    private static native JavaScriptObject createPeer(EventListener<?> listener) /*-{
		return function(e) {
			...
			listener.@com.emitrom.flash4j.core.client.events.EventListener::fireOnEvent(Lcom/emitrom/flash4j/core/client/events/Event;)(eventObject);
		};
