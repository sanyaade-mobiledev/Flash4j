...
package com.emitrom.flash4j.core.client.desktop;
...
public enum ClipboardTransferMode {
    ...
    public static native ClipboardTransferMode fromValue(String value) /*-{
		switch (value) {
		case 'cloneOnly':
			return @com.emitrom.flash4j.core.client.desktop.ClipboardTransferMode::CLONE_ONLY;

		case 'clonePreferred':
			return @com.emitrom.flash4j.core.client.desktop.ClipboardTransferMode::CLONE_PREFERRED;

		case 'originalOnly':
			return @com.emitrom.flash4j.core.client.desktop.ClipboardTransferMode::ORIGINAL_ONLY;

		case 'originalPreferred':
			return @com.emitrom.flash4j.core.client.desktop.ClipboardTransferMode::ORIGINAL_PREFERRED;
