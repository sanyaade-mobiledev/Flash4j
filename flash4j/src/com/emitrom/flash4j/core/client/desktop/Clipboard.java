 ...
 * 
 */
public final class Clipboard extends ProxyObject {
    ...
    private final native Clipboard getGeneralClipboard() /*-{
		...
		var toRetrn = @com.emitrom.flash4j.core.client.desktop.Clipboard::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    private native JavaScriptObject createNativeDataHandler(ClipboardDataHandler handler) /*-{
		return function() {
			return handler.@com.emitrom.flash4j.core.client.desktop.ClipboardDataHandler::getData()();
		}
    }-*/;
