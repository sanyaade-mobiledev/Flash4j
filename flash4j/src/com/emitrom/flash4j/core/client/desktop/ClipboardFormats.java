...
public enum ClipboardFormats {
    ...
    public static native ClipboardFormats fromValue(String value) /*-{
		switch (value) {
		case 'air:html':
			return @com.emitrom.flash4j.core.client.desktop.ClipboardFormats::HTML_FORMAT;

		case 'air:text':
			return @com.emitrom.flash4j.core.client.desktop.ClipboardFormats::TEXT_FORMAT;

		case 'air:rtf':
			return @com.emitrom.flash4j.core.client.desktop.ClipboardFormats::RICH_TEXT_FORMAT;
