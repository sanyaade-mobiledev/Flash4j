/************************************************************************
  JsoHelper.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
**************************************************************************/
package com.emitrom.flash4j.core.client;
...
public class JsoHelper {
    ...
    public static native JavaScriptObject[] getAttributeAsJavaScriptObjectArray(JavaScriptObject elem, String attr) /*-{
		...
		return (arrayJS === undefined) ? null
				: @com.emitrom.flash4j.core.client.JsoHelper::toArray(Lcom/google/gwt/core/client/JavaScriptObject;)(arrayJS);
    }-*/;
    ...
    public static native Date getAttributeAsDate(JavaScriptObject elem, String attr) /*-{
                                                                                   var ret = elem[attr];
                                                                                   return (ret === undefined || ret == null) ? null: @com.emitrom.flash4j.core.client.JsoHelper::toDate(D)(ret.getTime());
                                                                                   }-*/;
    ...
    public static native int getJavaScriptObjectAs3ArraySize(JavaScriptObject elem) /*-{
		if (elem)
    ...
    public static JavaScriptObject convertToJavaScriptArray(Object[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            } else if (val instanceof ProxyObject) {
                JsoHelper.setArrayValue(jsArray, i, ((ProxyObject) val).getJsObj());
    ...
    public static native int getAs3ArrayLength(JavaScriptObject array) /*-{
    ...
    public static JavaScriptObject convertMapToJavascriptObject(Map valueMap) {
        ...
        for (Iterator iterator = valueMap.keySet().iterator(); iterator.hasNext();) {
            ...
            if (value instanceof ProxyObject) {
                setAttribute(valueJS, key, ((ProxyObject) value).getJsObj());
    ...
    public static native String[] getProperties(JavaScriptObject jsObj) /*-{
		var props = @com.emitrom.flash4j.core.client.JsoHelper::createJavaScriptArray()();
		for ( var k in jsObj) {
			props.push(k);
		}
		return @com.emitrom.flash4j.core.client.JsoHelper::convertToJavaStringArray(Lcom/google/gwt/core/client/JavaScriptObject;)(props);
    }-*/;
