...
import com.emitrom.flash4j.core.client.events.handlers.IOErrorHandler;
import com.emitrom.flash4j.core.client.events.handlers.ProgressHandler;
import com.emitrom.flash4j.core.client.events.handlers.SampleDataHandler;
import com.emitrom.flash4j.core.client.net.URLRequest;
import com.emitrom.flash4j.core.client.utils.ByteArray;
import com.emitrom.flash4j.core.client.utils.factories.SoundFactory;
...
public class Sound extends EventDispatcher {
    ...
    public native ID3Info getID3() /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer.getid3();
		return @com.emitrom.flash4j.core.client.media.ID3Info::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void load(URLRequest stream) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.load(stream.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void loadCompressedDataFromByteArray(ByteArray bytes, int bytesLength) /*-{
		...
		peer
				.loadCompressedDataFromByteArray(
						bytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						bytesLength);
    }-*/;
    ...
    public native SoundChannel play() /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer.play();
		return @com.emitrom.flash4j.core.client.media.SoundChannel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native SoundChannel play(double startTime, int loops, SoundTransform sndTransform) /*-{
		...
		var obj = peer
				.play(
						startTime,
						loops,
						sndTransform.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.media.SoundChannel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void addIOErrorHandler(IOErrorHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.emitrom.flash4j.core.client.events.IOErrorEvent::IO_ERROR,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.IOErrorEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.flash4j.core.client.events.handlers.IOErrorHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/IOErrorEvent;)(eventObject);
						}));
    }-*/;
    ...
    public native void addProgressHandler(ProgressHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.emitrom.flash4j.core.client.events.ProgressEvent::PROGRESS,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.ProgressEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.flash4j.core.client.events.handlers.ProgressHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/ProgressEvent;)(eventObject);
						}));
    }-*/;
    ...
    public native void addSampleDataHandler(SampleDataHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.emitrom.flash4j.core.client.events.SampleDataEvent::SAMPLE_DATA,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.SampleDataEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.flash4j.core.client.events.handlers.SampleDataHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/SampleDataEvent;)(eventObject);
						}));
    }-*/;
