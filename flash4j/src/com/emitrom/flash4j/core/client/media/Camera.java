...
import com.emitrom.flash4j.core.client.events.handlers.ActivityHandler;
import com.emitrom.flash4j.core.client.events.handlers.EventHandler;
import com.emitrom.flash4j.core.client.events.handlers.StatusHandler;
...
public class Camera extends EventDispatcher {
    ...
    public native void addStatusHandler(StatusHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.emitrom.flash4j.core.client.events.StatusEvent::STATUS,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.StatusEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.flash4j.core.client.events.handlers.StatusHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/StatusEvent;)(eventObject);
						}));
    }-*/;
    ...
    public native void addActivityHandler(ActivityHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.emitrom.flash4j.core.client.events.ActivityEvent::ACTIVITY,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.ActivityEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.flash4j.core.client.events.handlers.ActivityHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/ActivityEvent;)(eventObject);
						}));
    }-*/;
