...
public final class Microphone extends EventDispatcher {
    ...
    public native MicrophoneEnhancedOptions getEnhencedOptions() /*-{
		...
		return @com.emitrom.flash4j.core.client.media.MicrophoneEnhancedOptions::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setEnhencedOptions(MicrophoneEnhancedOptions value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setEnhencedOptions(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void setSoundtransform(SoundTransform soundTransform) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setSoundTransform(soundTransform.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
