...
public enum SoundCodec {
    ...
    public static native SoundCodec fromValue(String value) /*-{
		switch (value) {
		case 'NellyMoser':
			return @com.emitrom.flash4j.core.client.media.SoundCodec::NELLYMOSER;
		case 'Speex':
			return @com.emitrom.flash4j.core.client.media.SoundCodec::SPEEX;
		case 'pcma':
			return @com.emitrom.flash4j.core.client.media.SoundCodec::PCMA;
		case 'pcmu':
			return @com.emitrom.flash4j.core.client.media.SoundCodec::PCMU;
		}
    }-*/;
