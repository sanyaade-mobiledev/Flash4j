...
**************************************************************************/
package com.emitrom.flash4j.core.client.display3D;

import com.emitrom.flash4j.core.client.display.BitmapData;
import com.emitrom.flash4j.core.client.display3D.textures.CubeTexture;
import com.emitrom.flash4j.core.client.display3D.textures.Texture;
...
public class Context3D extends EventDispatcher {
    ...
    public native CubeTexture createCubeTexture(int size, String format, boolean optimizeForRenderToTexture)/*-{
		...
		return @com.emitrom.flash4j.core.client.display3D.textures.CubeTexture::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;

    public native IndexBuffer3D createIndexBuffer(int numIndices)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer.createIndexBuffer(numIndices);
		return @com.emitrom.flash4j.core.client.display3D.IndexBuffer3D::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native Texture createTexture(int width, int height, String format, boolean optimizeForRenderToTexture)/*-{
		...
		var obj = peer.createTexture(width, height, format,
				optimizeForRenderToTexture);
		return @com.emitrom.flash4j.core.client.display3D.textures.Texture::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void drawToBitmapData(BitmapData destination)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.drawToBitmapData(destination.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;

    public native void drawTriangles(IndexBuffer3D indexBuffer)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.drawTriangles(indexBuffer.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void drawTriangles(IndexBuffer3D indexBuffer, int firstIndex)/*-{
		...
		peer
				.drawTriangles(
						indexBuffer.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						firstIndex);
    }-*/;
    ...
    public native void setProgram(Program3D program)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setProgram(program.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void setRenderToTextute(TextureBase texture)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.renderToTextute(texture.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void setScissorRectangle(Rectangle rectangle)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setScissorRectangle(rectangle.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void setVertexBufferAt(int index, VertexBuffer3D buffer)/*-{
		...
		peer
				.setVertexBufferAt(
						index,
						buffer.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
