...
public enum LoaderVoucherSetting {
    ...
    public static native LoaderVoucherSetting fromValue(String value) /*-{
		switch (value) {
		case 'allowServer':
			return @com.emitrom.flash4j.core.client.net.drm.LoaderVoucherSetting::ALLOW_SERVER;

		case 'forceRefresh':
			return @com.emitrom.flash4j.core.client.net.drm.LoaderVoucherSetting::FORCE_REFRESH;

		case 'localOnly':
			return @com.emitrom.flash4j.core.client.net.drm.LoaderVoucherSetting::LOCAL_ONLY
