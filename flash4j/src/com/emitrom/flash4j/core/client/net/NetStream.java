/************************************************************************
  NetStream.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
import com.emitrom.flash4j.core.client.media.Microphone;
...
public class NetStream extends EventDispatcher {
    ...
    public native NetStreamInfo getInfo()/*-{
		...
		return @com.emitrom.flash4j.core.client.net.NetStreamInfo::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native NetStreamMulticastInfo getMulticastInfo()/*-{
		...
		return @com.emitrom.flash4j.core.client.net.NetStreamMulticastInfo::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void appendBytes(ByteArray value)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.appendBytes(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void attach(NetConnection connection)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.attach(connection.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void attachAudio(Microphone microphone)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.attachAudio(microphone.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void attachCamera(Camera camera, int snapshotMilliseconds)/*-{
		...
		peer
				.attachCamera(
						camera.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public native boolean onPeerConnect(NetStream subscriber)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.onPeerConnect(subscriber.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void preloadEmbeddedData(NetStreamPlayOptions param)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.preloadEmbeddedData(param.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
