...
public class URLRequest extends ProxyObject {
     ...
     * 
     * @param followRedirects the new follow redirects
     */
    ...
    public List<URLRequestHeader> getRequestHeaders() {
        ...
        for (int i = 0; i < size; i++) {
            list.add(new URLRequestHeader(JsoHelper.getValueFromJavaScriptObjectArray(nativePeers, i)));
        }
        return list;
    }
     ...
     * 
     * @param requestHeaders the new request headers
     */
