/************************************************************************
  NetGroupReceiveMode.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public enum NetGroupReceiveMode {
    ...
    public static native NetGroupReceiveMode fromValue(String value) /*-{
		switch (value) {
		case 'exact':
			return @com.emitrom.flash4j.core.client.net.NetGroupReceiveMode::EXACT;
		case 'nearest':
			return @com.emitrom.flash4j.core.client.net.NetGroupReceiveMode::NEAREST;
		}
    }-*/;
}
