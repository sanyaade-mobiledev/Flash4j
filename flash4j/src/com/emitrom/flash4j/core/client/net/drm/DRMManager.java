...
import com.emitrom.flash4j.core.client.events.DRMAuthenticationCompleteEvent;
import com.emitrom.flash4j.core.client.events.DRMAuthenticationErrorEvent;
import com.emitrom.flash4j.core.client.events.EventDispatcher;
import com.emitrom.flash4j.core.client.events.handlers.DRMErrorHandler;
...
public class DRMManager extends EventDispatcher {
    ...
    public final native void loadVoucher(DRMContentData drmContentData, String setting)/*-{
		...
		peer
				.loadVoucher(
						drmContentData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						setting);
    }-*/;
    ...
    public final native void loadPreviewVoucher(DRMContentData drmContentData)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.loadPreviewVoucher(drmContentData.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addDRMErrorHandler(DRMErrorHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.emitrom.flash4j.core.client.events.DRMErrorEvent::DRM_ERROR,
						$entry(function(e) {
							var eventObject = @com.emitrom.flash4j.core.client.events.DRMErrorEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.flash4j.core.client.events.handlers.DRMErrorHandler::onEvent(Lcom/emitrom/flash4j/core/client/events/DRMErrorEvent;)(eventObject);
						}));
    }-*/;
