...
public enum AuthenticationMethod {
    ...
    public static native AuthenticationMethod fromValue(String value) /*-{
		switch (value) {
		case 'anonymus':
			return @com.emitrom.flash4j.core.client.net.drm.AuthenticationMethod::ANONYMUS;
		case 'usernameAndPassword':
			return @com.emitrom.flash4j.core.client.net.drm.AuthenticationMethod::USERNAME_AND_PASSWORD;
		}
    }-*/;
}
