/************************************************************************
  NetGroupReplicationStrategy.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public enum NetGroupReplicationStrategy {
    ...
    public static native NetGroupReplicationStrategy fromValue(String value) /*-{
		switch (value) {
		case 'lowestFirst':
			return @com.emitrom.flash4j.core.client.net.NetGroupReplicationStrategy::LOWEST_FIRST;
		case 'rearestFirst':
			return @com.emitrom.flash4j.core.client.net.NetGroupReplicationStrategy::RAREST_FIRST;
		}
    }-*/;
}
