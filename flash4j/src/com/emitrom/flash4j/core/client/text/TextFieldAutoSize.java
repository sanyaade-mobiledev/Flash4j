...
public enum TextFieldAutoSize {
    ...
    public static native TextFieldAutoSize fromValue(String value) /*-{
		switch (value) {
		case 'center':
			return @com.emitrom.flash4j.core.client.text.TextFieldAutoSize::CENTER;

		case 'left':
			return @com.emitrom.flash4j.core.client.text.TextFieldAutoSize::LEFT;

		case 'none':
			return @com.emitrom.flash4j.core.client.text.TextFieldAutoSize::NONE;

		case 'right':
			return @com.emitrom.flash4j.core.client.text.TextFieldAutoSize::RIGHT;
