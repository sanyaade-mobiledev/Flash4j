...
public abstract class ProxyObject {
    ...
    public native String[] getProperties() /*-{
		...
		return @com.emitrom.flash4j.core.client.JsoHelper::getProperties(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj);
    }-*/;

    public static ProxyObject create(JavaScriptObject obj) {
