/************************************************************************
 * AssetLoader.java is part of Flash4j 3.0.0 Copyright 2012 Emitrom LLC
 * 
 ...
 * the License.
 **************************************************************************/
package com.emitrom.flash4j.core.client.assetloader;

import com.emitrom.flash4j.core.client.assetloader.events.BatchCompleteEvent;
import com.emitrom.flash4j.core.client.assetloader.handlers.BinaryFileLoadHandler;
import com.emitrom.flash4j.core.client.assetloader.handlers.ImageFileLoadHandler;
import com.emitrom.flash4j.core.client.assetloader.handlers.LoadDoneHandler;
import com.emitrom.flash4j.core.client.assetloader.handlers.TextFileLoadHandler;
import com.emitrom.flash4j.core.client.assetloader.handlers.XmlFileLoadHandler;
 ...
 * 
 * <pre>
 *  import com.emitrom.flash4j.core.client.assetloader.events.ProgressEvent;
...
public class AssetLoader extends EventDispatcher {
    ...
    public static void addBatchCompleteHandler(EventListener<Event> handler) {
        addListener(BatchCompleteEvent.BATCH_COMPLETE, handler);
    }
    ...
    public static void addListener(String type, EventListener<?> listener) {
    ...
    private final native void _loadFile(String fileUrl, TextFileLoadHandler handler)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.loadFile(
						fileUrl,
						function(content) {
							return handler.@com.emitrom.flash4j.core.client.assetloader.handlers.TextFileLoadHandler::onLoad(Ljava/lang/String;)(content);
						});
    }-*/;

    private final native void _loadFile(String fileUrl, ImageFileLoadHandler handler)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.loadFile(
						fileUrl,
						function(content) {
							var bitmap = @com.emitrom.flash4j.core.client.display.Bitmap::new(Lcom/google/gwt/core/client/JavaScriptObject;)(content);
							return handler.@com.emitrom.flash4j.core.client.assetloader.handlers.ImageFileLoadHandler::onLoad(Lcom/emitrom/flash4j/core/client/display/Bitmap;)(bitmap);
						});
    }-*/;

    private final native void _loadFile(String xmlFilePath, XmlFileLoadHandler handler)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.loadFile(
						xmlFilePath,
						function(xml) {
							var xmlObject = @com.emitrom.flash4j.core.client.toplevel.XML::new(Lcom/google/gwt/core/client/JavaScriptObject;)(xml);
							return handler.@com.emitrom.flash4j.core.client.assetloader.handlers.XmlFileLoadHandler::onLoad(Lcom/emitrom/flash4j/core/client/toplevel/XML;)(xmlObject);
						});
    }-*/;

    private final native void _loadFile(String filePath, BinaryFileLoadHandler handler)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.loadFile(
						filePath,
						function(content) {
							var bytes = @com.emitrom.flash4j.core.client.utils.ByteArray::new(Lcom/google/gwt/core/client/JavaScriptObject;)(content);
							return handler.@com.emitrom.flash4j.core.client.assetloader.handlers.BinaryFileLoadHandler::onLoad(Lcom/emitrom/flash4j/core/client/utils/ByteArray;)(bytes);
						});
    }-*/;
    ...
    private final native void _whenDone(LoadDoneHandler handler)/*-{
		...
		peer
				.whenDone(function(e) {
					...
					handler.@com.emitrom.flash4j.core.client.assetloader.handlers.LoadDoneHandler::onLoadDone(Lcom/emitrom/flash4j/core/client/events/Event;)(eventObject);
				});
    }-*/;
