...
public class Transform extends ProxyObject {
    ...
    public native ColorTransform getColorTransform() /*-{
		...
		return @com.emitrom.flash4j.core.client.geom.ColorTransform::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setColorTransform(ColorTransform value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setcolorTransform(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void setMatrix3D(Matrix3D value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setmatrix3D(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native PerspectiveProjection getPerpectiveProjection() /*-{
		...
		return @com.emitrom.flash4j.core.client.geom.PerspectiveProjection::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setPerpectiveProjection(PerspectiveProjection value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setperspectiveProjection(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native Matrix3D getRelativeMatrix3D(DisplayObject relativeTo) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.getrelativeMatrix3D(relativeTo.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Matrix3D::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
