...
public class Vector3D extends ProxyObject {
    ...
    public native Vector3D add(Vector3D value) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.add(value.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    ...
    public native Vector3D crossProduct(Vector3D a, Vector3D d) /*-{
		...
		return peer.crossProduct(
				a.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
				b.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void decrementBy(Vector3D v) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.decrementBy(v.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native double dotProduct(Vector3D v) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		return peer
				.dotProduct(v.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native boolean equals(Vector3D toCompare, boolean allFour) /*-{
		...
		return peer
				.equals(
						toComparev.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						allFour);
    }-*/;
    ...
    public native boolean nearEquals(Vector3D toCompare, double tolerance) /*-{
		...
		return peer
				.nearEquals(
						toCompare.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						tolerance);
    }-*/;
    ...
    public native Vector3D substract(Vector3D v) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.substract(v.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Vector3D::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
