...
public enum Orientation3D {
    ...
    public static native Orientation3D fromValue(String value) /*-{
		...
		case 'axisAngle':
			return @com.emitrom.flash4j.core.client.geom.Orientation3D::AXIS_ANGLE;

		case 'eulerAngles':
			return @com.emitrom.flash4j.core.client.geom.Orientation3D::EULER_ANGLES

		case 'quaternion':
			return @com.emitrom.flash4j.core.client.geom.Orientation3D::QUATERNION;
