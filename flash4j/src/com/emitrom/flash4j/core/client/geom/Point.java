...
public class Point extends ProxyObject {
    ...
    private native Point _interpolate(Point pt1, Point pt2, double f) /*-{
		...
		var obj = peer.interpolate(
				pt1.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
				pt2.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
				f);
    ...
    public native Point add(Point v) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.add(v.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Point::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void copyFrom(Point source) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.copyFrom(source.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native Point substract(Point p) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		var obj = peer
				.substract(p.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
		return @com.emitrom.flash4j.core.client.geom.Point::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
