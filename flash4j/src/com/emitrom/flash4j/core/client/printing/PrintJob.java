...
public class PrintJob extends EventDispatcher {
    ...
    public native void addPage(Sprite sprite) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addPage(sprite.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addPage(Sprite sprite, Rectangle printArea) /*-{
		...
		peer
				.addPage(
						sprite.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						printArea.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addPage(Sprite sprite, Rectangle printArea, PrintJobOptions options) /*-{
		...
		peer
				.addPage(
						sprite.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						printArea.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						options.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
