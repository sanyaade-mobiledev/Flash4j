...
public enum PrintJobOrientation {
    ...
    public static native PrintJobOrientation fromValue(String value) /*-{
		switch (value) {
		case 'landscape':
			return @com.emitrom.flash4j.core.client.printing.PrintJobOrientation::LANDSCAPE;

		case 'portrait':
			return @com.emitrom.flash4j.core.client.printing.PrintJobOrientation::PORTRAIT;
		}
    }-*/;
