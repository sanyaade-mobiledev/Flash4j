/************************************************************************
  WindowUI.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public enum WindowUI {
    ...
    public static native WindowUI fromValue(String value) /*-{
		switch (value) {
		case 'true':
			return @com.emitrom.flash4j.alivepdf.client.viewing.WindowUI::SHOW;
		case 'false':
			return @com.emitrom.flash4j.alivepdf.client.viewing.WindowUI::HIDE;
		}
    }-*/;
}
