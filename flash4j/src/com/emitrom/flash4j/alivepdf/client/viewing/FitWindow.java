/************************************************************************
  FitWindow.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public enum FitWindow {
    ...
    public static native FitWindow fromValue(String value) /*-{
		switch (value) {
		case 'true':
			return @com.emitrom.flash4j.alivepdf.client.viewing.FitWindow::RESIZED;
		case 'false':
			return @com.emitrom.flash4j.alivepdf.client.viewing.FitWindow::DEFAULT;
		}
    }-*/;
