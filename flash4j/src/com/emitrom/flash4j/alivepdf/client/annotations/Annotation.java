/************************************************************************
 * Annotation.java is part of Flash4j 3.0.0 Copyright 2012 Emitrom LLC
 * 
...
package com.emitrom.flash4j.alivepdf.client.annotations;
 ...
 */
public class Annotation extends ProxyObject {
    ...
    public Annotation(AnnotationType type, String text, double x, double y) {
        jsObj = AlivePdfFactory.INSTANCE.createAnnotation(type.value, text, x, y);
    }
     ...
     * @return the annotation
     */
    public Annotation(AnnotationType type, String text, double x, double y, double width) {
        jsObj = AlivePdfFactory.INSTANCE.createAnnotation(type.value, text, x, y, width);
    }
     ...
     * @return the annotation
     */
    public Annotation(AnnotationType type, String text, double x, double y, double width, double height) {
        jsObj = AlivePdfFactory.INSTANCE.createAnnotation(type.value, text, x, y, width, height);
    }
