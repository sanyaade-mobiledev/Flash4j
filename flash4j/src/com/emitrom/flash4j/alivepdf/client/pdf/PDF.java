/************************************************************************
 * PDF.java is part of Flash4j 3.0.0 Copyright 2012 Emitrom LLC
 * 
...
package com.emitrom.flash4j.alivepdf.client.pdf;

import java.util.ArrayList;
import java.util.List;

import com.emitrom.flash4j.alivepdf.client.annotations.Annotation;
import com.emitrom.flash4j.alivepdf.client.codabar.CodaBar;
import com.emitrom.flash4j.alivepdf.client.colors.RGBColor;
import com.emitrom.flash4j.alivepdf.client.core.PDFFactory;
import com.emitrom.flash4j.alivepdf.client.drawing.Blend;
import com.emitrom.flash4j.alivepdf.client.drawing.Caps;
import com.emitrom.flash4j.alivepdf.client.drawing.DashedLine;
import com.emitrom.flash4j.alivepdf.client.drawing.Joint;
import com.emitrom.flash4j.alivepdf.client.fonts.IFont;
import com.emitrom.flash4j.alivepdf.client.grid.Grid;
import com.emitrom.flash4j.alivepdf.client.images.ColorSpace;
import com.emitrom.flash4j.alivepdf.client.images.ImageFormat;
import com.emitrom.flash4j.alivepdf.client.layout.Align;
import com.emitrom.flash4j.alivepdf.client.layout.Layout;
import com.emitrom.flash4j.alivepdf.client.layout.Mode;
import com.emitrom.flash4j.alivepdf.client.layout.Orientation;
import com.emitrom.flash4j.alivepdf.client.layout.Position;
import com.emitrom.flash4j.alivepdf.client.layout.Resize;
import com.emitrom.flash4j.alivepdf.client.layout.Size;
import com.emitrom.flash4j.alivepdf.client.layout.Unit;
import com.emitrom.flash4j.alivepdf.client.links.Highlight;
import com.emitrom.flash4j.alivepdf.client.links.ILink;
import com.emitrom.flash4j.alivepdf.client.links.InternalLink;
import com.emitrom.flash4j.alivepdf.client.pages.Page;
import com.emitrom.flash4j.alivepdf.client.saving.Download;
import com.emitrom.flash4j.alivepdf.client.saving.Method;
...
import com.emitrom.flash4j.alivepdf.client.viewing.CenterWindow;
import com.emitrom.flash4j.alivepdf.client.viewing.FitWindow;
import com.emitrom.flash4j.alivepdf.client.viewing.MenuBar;
import com.emitrom.flash4j.alivepdf.client.viewing.Title;
import com.emitrom.flash4j.alivepdf.client.viewing.ToolBar;
import com.emitrom.flash4j.alivepdf.client.viewing.WindowUI;
...
public class PDF extends EventDispatcher {
    ...
    public PDF(Orientation orientation, Unit unit, boolean autoBreak) {
        jsObj = PDFFactory.INSTANCE.newInstance(orientation.value, unit.value, autoBreak);
    }
     ...
     * @return the pDF
     */
    public PDF(Orientation orientation, Unit unit, boolean autoBreak, Size pageSize) {
        jsObj = PDFFactory.INSTANCE.newInstance(orientation.value, unit.value, autoBreak, pageSize);
    }
     ...
     * @return the pDF
     */
    public PDF(Orientation orientation, Unit unit, boolean autoBreak, Size pageSize, int rotation) {
        jsObj = PDFFactory.INSTANCE.newInstance(orientation.value, unit.value, autoBreak, pageSize, rotation);
    }
     ...
     *            the bottom
     */
    public final native void setMargins(double left, double top, double right, double bottom) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the mode
     */
    private final native void _setDisplayMode(String zoom, String layout, String mode) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the zoom value
     */
    public final void setDisplayMode(String zoom, Layout layout, Mode mode, double zoomValue) {
     ...
     *            the zoom value
     */
    private final native void _setDisplayMode(String zoom, String layout, String mode, double zoomValue) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final List<Page> getPages() {
        ...
        for (int i = 0; i < length; i++) {
            pages.add(new Page(JsoHelper.getValueFromJavaScriptObjectArray(peers, i)));
        }
        return pages;
    }
     ...
     *            the position
     */
    public final native void footer(String footerText, boolean showPageNumber, String position) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the final y3
     */
    public final native void curveTo(double controlX1, double controlY1, double controlX2, double controlY2,
                    double finalX3, double finalY3) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final native void lineStyle(RGBColor color) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.lineStyle(color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
     ...
     *            the flatness
     */
    public final native void lineStyle(RGBColor color, double thickness, double flatness) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.lineStyle(
						color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the alpha
     */
    public final native void lineStyle(RGBColor color, double thickness, double flatness, double alpha) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.lineStyle(
						color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the rule
     */
    public final native void lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.lineStyle(
						color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the blend mode
     */
    public final void lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    Blend blendMode) {
     ...
     *            the blend mode
     */
    private final native void _lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    String blendMode) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     */
    public final void lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    Blend blendMode, DashedLine style) {
        _lineStyle(color, thickness, flatness, alpha, rule, blendMode.value, style);
    }
     ...
     */
    private final native void _lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    String blendMode, DashedLine style) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer.lineStyle(color, thickness, flatness, alpha, rule, blendMode,
				style);
    }-*/;
     ...
     */
    public final void lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    Blend blendMode, DashedLine style, Caps caps) {
        _lineStyle(color, thickness, flatness, alpha, rule, blendMode.value, style, caps.value);
    }
     ...
     */
    private final native void _lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    String blendMode, DashedLine style, String caps) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer.lineStyle(color, thickness, flatness, alpha, rule, blendMode,
				style, caps);
    }-*/;
     ...
     */
    public final void lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    Blend blendMode, DashedLine style, Caps caps, Joint joints) {
        _lineStyle(color, thickness, flatness, alpha, rule, blendMode.value, style, caps.value, joints.value);
    }
     ...
     */
    private final native void _lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    String blendMode, DashedLine style, String caps, String joints) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer.lineStyle(color, thickness, flatness, alpha, rule, blendMode,
				style, caps, joints);
    }-*/;
     ...
     */
    public final void lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    Blend blendMode, DashedLine style, Caps caps, Joint joints, double miterLimit) {
        _lineStyle(color, thickness, flatness, alpha, rule, blendMode.value, style, caps.value, joints.value,
                        miterLimit);
    }
     ...
     */
    private final native void _lineStyle(RGBColor color, double thickness, double flatness, double alpha, String rule,
                    String blendMode, DashedLine style, String caps, String joints, double miterLimit) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer.lineStyle(color, thickness, flatness, alpha, rule, blendMode,
    ...
    public final native void beginnFill(RGBColor color) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.beginnFill(color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
     ...
     *            the bitmap
     */
    public final native void beginnBitmapFill(BitmapData bitmap) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.beginnBitmapFill(bitmap.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
     ...
     *            the matrix
     */
    public final native void beginnBitmapFill(BitmapData bitmap, Matrix matrix) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.beginnBitmapFill(
						bitmap.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public final native void drawRect(Rectangle rectangle) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.drawRect(rectangle.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
     ...
     *            the ellipse width
     */
    public final native void drawRoundRect(Rectangle rectangle, double ellipseWidth) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.drawRoundRect(
						rectangle.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						ellipseWidth);
    }-*/;
     ...
     */
    public final native void drawRoundRectComplex(Rectangle rectangle, double topLeftEllipseWidth,
                    double topRightEllipseWidth, double bottomLeftEllipseWidth, double bottomRightEllipseWidth) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
     ...
     *            the radius y
     */
    public final native void drawEllipse(double x, double y, double radiusX, double radiusY) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the b
     */
    public final native void drawSector(double xCenter, double yCenter, double radius, double a, double b) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the style
     */
    public final native void drawSector(double xCenter, double yCenter, double radius, double a, double b, String style) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     */
    public final native void drawSector(double xCenter, double yCenter, double radius, double a, double b,
                    String style, boolean clockWise) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     */
    public final native void drawSector(double xCenter, double yCenter, double radius, double a, double b,
                    String style, boolean clockWise, double alignOrigin) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer.drawSector(xCenter, yCenter, radius, a, b, style, clockWise,
				alignOrigin);
    }-*/;
    ...
    public final native void addCodaBar(CodaBar codaBar) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addCodaBar(codaBar.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public final native void addAnnotation(Annotation annotation) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addAnnotation(annotation.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
     ...
     *            the color
     */
    public final native void addBookmark(String text, int level, double y, RGBColor color) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addBookmark(
						text,
     ...
     *            the link
     */
    public final native void addLink(double x, double y, double width, double height, ILink link) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer.addLink(x, y, width, height, link
				.@com.emitrom.flash4j.alivepdf.client.links.ILink::asILink());
    }-*/;
     ...
     *            the highliht
     */
    public final void addLink(double x, double y, double width, double height, ILink link, Highlight highliht) {
     ...
     *            the highliht
     */
    private final native void _addLink(double x, double y, double width, double height, ILink link, String highliht) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addLink(
						x,
						...
						width,
						height,
						link.@com.emitrom.flash4j.alivepdf.client.links.ILink::asILink()(),
						highliht);
    }-*/;
    ...
    public final native InternalLink getCurrentInternalLink() /*-{
		...
		return @com.emitrom.flash4j.alivepdf.client.links.InternalLink::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
     ...
     *            the dimension
     */
    public final void addTransition(Transition style, double duration, Dimension dimension) {
     ...
     *            the dimension
     */
    private final native void _addTransition(String style, double duration, String dimension) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final void addTransition(Transition style, double duration, Dimension dimension,
        ...
        _addTransition(style.value, duration, dimension.value, motionDirection.value);
    }
     ...
     *            the motion direction
     */
    private final native void _addTransition(String style, double duration, String dimension, String motionDirection) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final void addTransition(Transition style, double duration, Dimension dimension,
        ...
        _addTransition(style.value, duration, dimension.value, motionDirection.value, transitionDirection.value);
    }
     ...
     *            the menubar
     */
    private final native void _setViewerPreferences(String toolbar, String menubar) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the window ui
     */
    public final void setDefaultPreference(ToolBar toolbar, MenuBar menubar, WindowUI windowUI) {
     ...
     *            the window ui
     */
    private final native void _setViewerPreferences(String toolbar, String menubar, String windowUI) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the fit window
     */
    public final void setDefaultPreference(ToolBar toolbar, MenuBar menubar, WindowUI windowUI, FitWindow fitWindow) {
        _setViewerPreferences(toolbar.value, menubar.value, windowUI.value, fitWindow.value);
    }
     ...
     *            the fit window
     */
    private final native void _setViewerPreferences(String toolbar, String menubar, String windowUI, String fitWindow) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final void setDefaultPreference(ToolBar toolbar, MenuBar menubar, WindowUI windowUI, FitWindow fitWindow,
        ...
        _setViewerPreferences(toolbar.value, menubar.value, windowUI.value, fitWindow.value, centerWindow.value);
    }
     ...
     */
    public final void setDefaultPreference(ToolBar toolbar, MenuBar menubar, WindowUI windowUI, FitWindow fitWindow,
                    CenterWindow centerWindow, Title displayTitle) {
        _setViewerPreferences(toolbar.value, menubar.value, windowUI.value, fitWindow.value, centerWindow.value,
                        displayTitle.value);
    }
    ...
    public final native void setFont(IFont font) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.setFont(font.@com.emitrom.flash4j.alivepdf.client.fonts.IFont::asIFont()());
    }-*/;
    ...
    public final native void setFont(IFont font, int size) /*-{
		...
		peer
				.setFont(
						font.@com.emitrom.flash4j.alivepdf.client.fonts.IFont::asIFont()(),
						size);
    }-*/;
    ...
    public final native void removeFont(IFont font) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.removeFont(font.@com.emitrom.flash4j.alivepdf.client.fonts.IFont::asIFont()());
    }-*/;
    ...
    public final native void setTextStyle(RGBColor color) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.textStyle(color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
     ...
     *            the rendering
     */
    public final native void setTextStyle(RGBColor color, double alpha, int rendering) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.textStyle(
						color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the word space
     */
    public final native void setTextStyle(RGBColor color, double alpha, int rendering, double wordSpace) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.textStyle(
						color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     */
    public final native void setTextStyle(RGBColor color, double alpha, int rendering, double wordSpace,
                    double characterSpace, double scale) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.textStyle(
						color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     */
    public final native void setTextStyle(RGBColor color, double alpha, int rendering, double wordSpace,
                    double characterSpace, double scale, double leading) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.textStyle(
						color.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the border
     */
    public final native void addCell(double width, double height, String text, double border) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the ln
     */
    public final native void addCell(double width, double height, String text, double border, double ln) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the align
     */
    private final native void _addCell(double width, double height, String text, double border, double ln, String align) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the fill
     */
    private final native void _addCell(double width, double height, String text, double border, double ln,
                    String align, double fill) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     */
    private final native void _addCell(double width, double height, String text, double border, double ln,
                    String align, double fill, ILink link) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the text
     */
    public final native void addCellFitScale(double width, double height, String text) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the border
     */
    public final native void addCellFitScale(double width, double height, String text, double border) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the ln
     */
    public final native void addCellFitScale(double width, double height, String text, double border, double ln) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the align
     */
    public final void addCellFitScale(double width, double height, String text, double border, double ln, Align align) {
     ...
     *            the align
     */
    private final native void _addCellFitScale(double width, double height, String text, double border, double ln,
                    String align) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final void addCellFitScale(double width, double height, String text, double border, double ln, Align align,
                    double fill, ILink link) {
        _addCellFitScale(width, height, text, border, ln, align.value, fill, link);
    }
     ...
     *            the text
     */
    public final native void addCellFitScaleForce(double width, double height, String text) /*-{
     ...
     *            the border
     */
    public final native void addCellFitScaleForce(double width, double height, String text, double border) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the ln
     */
    public final native void addCellFitScaleForce(double width, double height, String text, double border, double ln) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the align
     */
    public final void addCellFitScaleForce(double width, double height, String text, double border, double ln,
                    Align align) {
     ...
     *            the align
     */
    private final native void _addCellFitScaleForce(double width, double height, String text, double border, double ln,
                    String align) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     */
    public final void addCellFitScaleForce(double width, double height, String text, double border, double ln,
                    Align align, double fill) {
        _addCellFitScaleForce(width, height, text, border, ln, align.value, fill);
    }
     ...
     */
    public final void addCellFitScaleForce(double width, double height, String text, double border, double ln,
                    Align align, double fill, ILink link) {
        _addCellFitScaleForce(width, height, text, border, ln, align.value, fill, link);
    }
     ...
     *            the text
     */
    public final native void addCellFitSpace(double width, double height, String text) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the border
     */
    public final native void addCellFitSpace(double width, double height, String text, double border) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the ln
     */
    public final native void addCellFitSpace(double width, double height, String text, double border, double ln) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the align
     */
    public final void addCellFitSpace(double width, double height, String text, double border, double ln, Align align) {
     ...
     *            the align
     */
    private final native void _addCellFitSpace(double width, double height, String text, double border, double ln,
                    String align) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final void addCellFitSpace(double width, double height, String text, double border, double ln, Align align,
                    double fill, ILink link) {
        _addCellFitSpace(width, height, text, border, ln, align.value, fill, link);
    }
     ...
     *            the text
     */
    public final native void addCellFitSpaceForce(double width, double height, String text) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the border
     */
    public final native void addCellFitSpaceForce(double width, double height, String text, double border) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the ln
     */
    public final native void addCellFitSpaceForce(double width, double height, String text, double border, double ln) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the align
     */
    public final void addCellFitSpaceForce(double width, double height, String text, double border, double ln,
                    Align align) {
     ...
     *            the align
     */
    private final native void _addCellFitSpaceForce(double width, double height, String text, double border, double ln,
                    String align) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final void addCellFitSpaceForce(double width, double height, String text, double border, double ln,
                    Align align, double fill) {
        _addCellFitSpaceForce(width, height, text, border, ln, align.value, fill);
    }
    ...
    public final void addCellFitSpaceForce(double width, double height, String text, double border, double ln,
                    Align align, double fill, ILink link) {
        _addCellFitSpaceForce(width, height, text, border, ln, align.value, fill, link);
    }
     ...
     *            the text
     */
    public final native void addMultiCell(double width, double height, String text) /*-{
     ...
     *            the border
     */
    public final native void addMultiCell(double width, double height, String text, double border) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the align
     */
    public final void addCellMultiCrll(double width, double height, String text, double border, Align align) {
     ...
     *            the align
     */
    private final native void _addMultiCell(double width, double height, String text, double border, String align) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     *            the filled
     */
    public final void addCellMultiCrll(double width, double height, String text, double border, Align align, int filled) {
     ...
     *            the link
     */
    public final native void writeText(double lineHeight, String text, ILink link) /*-{
     ...
     *            the link
     */
    public final native void writeFlashHtmlText(double lineHeight, String text, ILink link) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final native void addGrid(Grid grid, int x) /*-{
		...
		peer
				.addGrid(
						grid.@com.emitrom.flash4j.alivepdf.client.grid.Grid::getJsObj()(),
						x);
    }-*/;
     ...
     *            the repeat header
     */
    public final native void addGrid(Grid grid, int x, int y, boolean repeatHeader) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addGrid(
						grid.@com.emitrom.flash4j.alivepdf.client.grid.Grid::getJsObj()(),
     ...
     *            the yvalue
     */
    public final native void setGridPositionOnNextPages(double xvalue, double yvalue) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     * @return the byte array
     */
    public final ByteArray save(Method method, String url, Download downloadMethod) {
     ...
     * @return the byte array
     */
    private final native ByteArray _save(String method, String url, String downloadMethod) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     * @return the byte array
     */
    public final ByteArray save(Method method, String url, Download downloadMethod, String fileName) {
     ...
     * @return the byte array
     */
    private final native ByteArray _save(String method, String url, String downloadMethod, String fileName) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
     ...
     * @return the byte array
     */
    public final ByteArray save(Method method, String url, Download downloadMethod, String fileName, String frame) {
     ...
     * @return the byte array
     */
    private final native ByteArray _save(String method, String url, String downloadMethod, String fileName, String frame) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
    ...
    public final native void addEPSImage(ByteArray stream) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addEPSImage(stream.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public final native void addEPSImage(ByteArray stream, double x) /*-{
		...
		peer
				.addEPSImage(
						stream.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						x);
    }-*/;
     ...
     *            the w
     */
    public final native void addEPSImage(ByteArray stream, double x, double y, double w) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addEPSImage(
						stream.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the h
     */
    public final native void addEPSImage(ByteArray stream, double x, double y, double w, double h) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addEPSImage(
						stream.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the color space
     */
    private final native void _addImageStream(ByteArray imageBytes, String colorSpace) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImageStream(
						imageBytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						colorSpace);
    }-*/;
     ...
     *            the resize
     */
    public final void addImageStream(ByteArray imageBytes, ColorSpace colorSpace, Resize resize) {
     ...
     *            the resize mode
     */
    private final native void _addImageStream(ByteArray imageBytes, String colorSpace, Resize resizeMode) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImageStream(
						imageBytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						colorSpace,
						resizeMode.@com.emitrom.flash4j.alivepdf.client.layout.Resize::getJsObj()());
    }-*/;
     ...
     *            the x
     */
    public final void addImageStream(ByteArray imageBytes, ColorSpace colorSpace, Resize resize, double x) {
     ...
     *            the x
     */
    private final native void _addImageStream(ByteArray imageBytes, String colorSpace, Resize resizeMode, double x) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImageStream(
						imageBytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the y
     */
    public final void addImageStream(ByteArray imageBytes, ColorSpace colorSpace, Resize resize, double x, double y) {
        _addImageStream(imageBytes, colorSpace.value, resize, x, y);
    }

    public final void addImageStream(ByteArray imageBytes, double x) {
        this.addImageStream(imageBytes, ColorSpace.DEVICE_RGB, new Resize(Mode.FIT_TO_PAGE, Position.LEFT), x);
    }

    public final void addImageStream(ByteArray imageBytes, double x, double y) {
        this.addImageStream(imageBytes, ColorSpace.DEVICE_RGB, new Resize(Mode.FIT_TO_PAGE, Position.LEFT), x, y);
    }
    ...
    public final void addImageStream(ByteArray imageBytes, ColorSpace colorSpace, Resize resize, double x, double y,
        ...
        _addImageStream(imageBytes, colorSpace.value, resize, x, y, width, height);
    }
    ...
    public final void addImageStream(ByteArray imageBytes, ColorSpace colorSpace, Resize resize, double x, double y,
        ...
        _addImageStream(imageBytes, colorSpace.value, resize, x, y, width, height, rotation);
    }
    ...
    public final void addImageStream(ByteArray imageBytes, ColorSpace colorSpace, Resize resize, double x, double y,
        ...
        _addImageStream(imageBytes, colorSpace.value, resize, x, y, width, height, rotation, alpha);
    }
     ...
     */
    private final native void _addImageStream(ByteArray imageBytes, String colorSpace, Resize resizeMode, double x,
                    double y, double width, double height, double rotation, double alpha) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImageStream(
						imageBytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     */
    public final void addImageStream(ByteArray imageBytes, ColorSpace colorSpace, Resize resize, double x, double y,
                    double width, double height, double rotation, double alpha, BlendMode blendMode) {
        _addImageStream(imageBytes, colorSpace.value, resize, x, y, width, height, rotation, alpha, blendMode.value);
    }
     ...
     */
    private final native void _addImageStream(ByteArray imageBytes, String colorSpace, Resize resizeMode, double x,
                    double y, double width, double height, double rotation, double alpha, String blendMode) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImageStream(
						imageBytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     */
    public final void addImageStream(ByteArray imageBytes, ColorSpace colorSpace, Resize resize, double x, double y,
                    double width, double height, double rotation, double alpha, BlendMode blendMode, ILink link) {
        _addImageStream(imageBytes, colorSpace.value, resize, x, y, width, height, rotation, alpha, blendMode.value,
                        link);
    }
     ...
     */
    private final native void _addImageStream(ByteArray imageBytes, String colorSpace, Resize resizeMode, double x,
                    double y, double width, double height, double rotation, double alpha, String blendMode, ILink link) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImageStream(
						imageBytes.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the resize mode
     */
    public final native void addImage(DisplayObject displayObject, Resize resizeMode) /*-{
     ...
     *            the x
     */
    public final native void addImage(DisplayObject displayObject, Resize resizeMode, double x) /*-{
     ...
     *            the y
     */
    public final native void addImage(DisplayObject displayObject, Resize resizeMode, double x, double y) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImage(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						resizeMode.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
						x, y);
    }-*/;
     ...
     *            the width
     */
    public final native void addImage(DisplayObject displayObject, Resize resizeMode, double x, double y, double width) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImage(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     */
    public final native void addImage(DisplayObject displayObject, Resize resizeMode, double x, double y, double width,
                    double height, double rotation, double alpha) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImage(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     */
    public final native void addImage(DisplayObject displayObject, Resize resizeMode, double x, double y, double width,
                    double height, double rotation, double alpha, boolean keepTransformation) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImage(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
     ...
     *            the image format
     */
    public final void addImage(DisplayObject displayObject, Resize resizeMode, double x, double y, double width,
                    double height, double rotation, double alpha, boolean keepTransformation, ImageFormat imageFormat) {
        _addImage(displayObject, resizeMode, x, y, width, height, rotation, alpha, keepTransformation,
                        imageFormat.value);
    }
     ...
     *            the image format
     */
    private final native void _addImage(DisplayObject displayObject, Resize resizeMode, double x, double y,
                    double width, double height, double rotation, double alpha, boolean keepTransformation,
                    String imageFormat) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addImage(
    ...
    public final void addImage(DisplayObject displayObject, Resize resizeMode, double x, double y, double width,
        ...
        _addImage(displayObject, resizeMode, x, y, width, height, rotation, alpha, keepTransformation,
                        imageFormat.value, quality, blendMode.value);
    }
    ...
    public final void addImage(DisplayObject displayObject, Resize resizeMode, double x, double y, double width,
        ...
        _addImage(displayObject, resizeMode, x, y, width, height, rotation, alpha, keepTransformation,
                        imageFormat.value, quality, blendMode.value, link);
    }
    ...
    public final void addDisplayObject(DisplayObject displayObject, Resize resizeMode) {
        _addDisplayObject(displayObject, resizeMode);
    }

    public final void addDisplayObject(DisplayObject displayObject, Resize resizeMode, double x) {
        _addDisplayObject(displayObject, resizeMode, x);
    }

    public final void addDisplayObject(DisplayObject displayObject, Resize resizeMode, double x, double y) {
        _addDisplayObject(displayObject, resizeMode, x, y);
    }

    public final void addDisplayObject(DisplayObject displayObject, Resize resizeMode, double x, double y, double width) {
    ...
    public final void addDisplayObject(DisplayObject displayObject, Resize resizeMode, double x, double y,
                    double width, double height, double rotation) {
        _addDisplayObject(displayObject, resizeMode, x, y, width, height, rotation);
    }

    public final void addDisplayObject(DisplayObject displayObject, Resize resizeMode, double x, double y,
                    double width, double height, double rotation, double alpha) {
        _addDisplayObject(displayObject, resizeMode, x, y, width, height, rotation, alpha);
    }

    public final void addDisplayObject(DisplayObject displayObject, Resize resizeMode, double x, double y,
                    double width, double height, double rotation, double alpha, boolean keepTransformation) {
        _addDisplayObject(displayObject, resizeMode, x, y, width, height, rotation, alpha, keepTransformation);
    }
    ...
    private final native void _addDisplayObject(DisplayObject displayObject) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addDisplayObject(displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;

    private final native void _addDisplayObject(DisplayObject displayObject, Resize resizeMode) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addDisplayObject(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    private final native void _addDisplayObject(DisplayObject displayObject, Resize resizeMode, double x) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addDisplayObject(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    private final native void _addDisplayObject(DisplayObject displayObject, Resize resizeMode, double x, double y) /*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addDisplayObject(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public final native void addBitmapData(BitmapData data)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addBitmapData(data.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public final native void addBitmapData(BitmapData data, Resize resize, double x)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addBitmapData(
						data.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public final native void addBitmapData(BitmapData data, Resize resize, double x, double y)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addBitmapData(
						data.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public final native void addBitmapData(BitmapData data, Resize resize, double x, double y, double width)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addBitmapData(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public final void addBitmapData(BitmapData data, Resize resize, double x, double y, double width, double height,
                    double rotation, double alpha, BlendMode blendMode) {
        this._addBitmapData(data, resize, x, y, width, height, rotation, alpha, blendMode.value);
    }

    private final native void _addBitmapData(BitmapData data, Resize resize, double x, double y, double width,
                    double height, double rotation, double alpha, String blendMode)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addBitmapData(
						displayObject.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
    ...
    public final void addBitmapData(BitmapData data, Resize resize, double x, double y, double width, double height,
                    double rotation, double alpha, BlendMode blendMode, ILink link) {
        this._addBitmapData(data, resize, x, y, width, height, rotation, alpha, blendMode.value, link);
    }

    private final native void _addBitmapData(BitmapData data, Resize resize, double x, double y, double width,
                    double height, double rotation, double alpha, String blendMode, ILink link)/*-{
		var peer = this.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()();
		peer
				.addBitmapData(
						data.@com.emitrom.flash4j.core.client.ProxyObject::getJsObj()(),
