/************************************************************************
  Shape.java is part of Flash4j 3.0.0  Copyright 2012 Emitrom LLC
...
public class Shape extends DisplayObject {
    ...
    public static native boolean isInstance(JavaScriptObject o) /*-{
		return o instanceof $wnd.runtime.flash.display.Shape;
    }-*/;

    protected Shape(JavaScriptObject obj) {
        jsObj = obj;
    }
    ...
    private static native JavaScriptObject newInstance() /*-{
		return new $wnd.runtime.flash.display.Shape();
    }-*/;
